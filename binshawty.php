...
$mainid = (array("1569782681,1569782681,1654087188")); #PUT HERE USERID
...
function checkId($userId){
    ...
    $mainids = array("1569782682,1569782682,1654087188"); #PUT HERE Premium USERID

    if($userId == "1569782681,1654087188"){#Add Here Your Id if ur owner
...
sendMessage($chatId, "<i>Hello $firstname now you can use /cmds%0A%0ABot Made by Art </i>");
...
sendMessage($chatId, "<i>YOUR ID: <code>$userId</code>%0AFirst Name: $firstname%0AUsername: @$username%0A%0ABot Made by Art </i>");
